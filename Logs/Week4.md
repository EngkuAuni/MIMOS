# Internship Log — Week 4 (Sept 2–4)
...
- discussed with the LLM team on ways to improve: using different models to gauge respective outputs, lappy cant support multi-model
- also talked about other projects I could contribute to; KKM PDRM thingy
